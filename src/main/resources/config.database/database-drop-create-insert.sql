...
Все квартиры предлагаются с полностью готовой чистовой отделкой высокого качества. Для каждого типа квартир разработан
авторский дизайн-проект интерьера, который подчеркивает и раскрывает достоинства планировочных решений. На выбор доступны
3 варианта отделки.
Для парковки автомобилей предусмотрен подземный паркинг с доступом на лифте в жилую часть зданий, а для хранения вещей -
кладовые помещения.
Дворы спроектированы по принципу "двор без машин", а главной особенностью проекта является наличие собственной
благоустроенной набережной вдоль канала им. Москвы.На территории комплекса также строится детский образовательный комплекс
со школой и детским садом.',
...
Огромная кухня-гостиная, две спальни, огромная гардеробная. Предусмотрена комната под кабинет. Два совмещенных санузла.
Панорамные окна. Балкон. Прекрасный вид из окон.
В подъезде видеонаблюдение. Подземный паркинг. Охраняемая территория. Развитая инфраструктура.
Свободная продажа. Полная стоимость в договоре.
Также есть машино-место.',
...
Закрытая территория жилого комплекса, продуманное благоустройство, эксплуатируемые кровли стилобата,
образовательный центр с детским садом создают приватное пространство для тихой семейной жизни, а городская
площадь с фонтанами, ресторан, супермаркет, коммерческая инфраструктура на первых этажах привносят созвучную
с ритмом города динамику.',
...
Поклонную гору, Москва-реку и Москва-Сити.
Эффектный ультрасовременный 58-этажный небоскреб, пластичный в нижней части, наверху трансформируется и
взмывает ввысь выразительной скульптурой с обтекаемой поверхностью. Фасад украшенный стеклянными эркерами
в виде прямых треугольных призм, словно олицетворяет собой идеально собранный пазл. Это безупречное решение
для тех, кто не боится лидерства и высоты, не ищет простых путей, держит высокую планку во всем, не останавливается
на достигнутом и живет в ритме мегаполиса. Не зря логотип Famous украшает графический элемент Триумфальной арки на
Кутузовском проспекте  символ успеха и жизненных побед.
',
...
Hide расположен рядом с Воробьевской набережной, по которой можно быстро доехать в центр или прогуляться до
парка Горького. Для жителей предусмотрен собственный благоустроенный вход в парк Долины реки Сетунь.
Новый фантастический проект комплекса Hide объединяет всё необходимое для комфортабельного проживания. Модный
и динамичный снаружи и потрясающе удобный внутри,  он охраняет покой и уединенность своих жителей.
',
